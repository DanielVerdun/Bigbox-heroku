...
def infobox(request, category_id):
    ...
    cinco_actividades= Activity.objects.all()[:5]
    
    return render(request, "infobox.html", {"boxs": boxs,"cinco_actividades":cinco_actividades})
...
def activity(request):
    ...
    return render(request, "activity.html",{"actividades":actividades,"actividades_page":actividades_page,#"activ":activ})
